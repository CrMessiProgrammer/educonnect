📘 SEÇÃO 1 — VISÃO GERAL DO SISTEMA (VERSÃO PROFISSIONAL E COMPLETA)
1.1 Nome do Sistema
...
Dashboard com gráficos (Chart.js ou PowerBI na versão final)
...
Documentação completa (diferencial raro em trainees)
...
Arquitetura escalável mesmo em um projeto front-end